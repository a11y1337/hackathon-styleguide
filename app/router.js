...
import CategoryListContainer from './components/containers/category-list-container';
import CategoryProfileContainer from './components/containers/category-profile-container';
  ...
  <Router history={browserHistory}>
    <Route component={MainLayout}>
      ...
      <Route path="categories">
        ...
        <Route path=":categoryId" component={CategoryProfileContainer} />
      </Route>
{/*
